...
# IMPORT_FILE_TO_SRCDIR ( rel_dst, <src file> )
define LIRAM_INITRAMFS_IMPORT_FILE_TO_SRCDIR
	set -e; if test -n '$(call qstrip,$(2))'; then \
		mkdir -p -- $(dir $(@D)/$(1)); \
		cp -L -- '$(call qstrip,$(2))' '$(@D)/$(1)'; \
	fi
endef
...
define LIRAM_INITRAMFS_DO_IMPORT_FILES
	...
	$(call LIRAM_INITRAMFS_IMPORT_FILE_TO_SRCDIR,liram/cmdline,\
		$(BR2_PACKAGE_LIRAM_INITRAMFS_CMDLINE_FILE))
endef
...
ifeq ($(call qstrip,$(BR2_PACKAGE_LIRAM_INITRAMFS_CMDLINE_FILE))),)
else
define LIRAM_INITRAMFS_DO_INSTALL_CMDLINE_FILE
	$(call LIRAM_INITRAMFS_INSFILE,cmdline,,)
endef
LIRAM_INITRAMFS_POST_INSTALL_TARGET_HOOKS += \
	LIRAM_INITRAMFS_DO_INSTALL_CMDLINE_FILE
endif
