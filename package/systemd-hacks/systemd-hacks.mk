...
SYSTEMD_HACKS__SYSTEMD_CONFDIR = /etc/systemd
SYSTEMD_HACKS__SYSTEMD_LIBDIR  = /lib/systemd

SYSTEMD_HACKS__SVCDIR_GETTY         = \
	$(SYSTEMD_HACKS__SYSTEMD_CONFDIR)/system/getty@.service.d
SYSTEMD_HACKS__SVCDIR_SERIAL_GETTY  = \
	$(SYSTEMD_HACKS__SYSTEMD_CONFDIR)/system/serial-getty@.service.d
SYSTEMD_HACKS__SVCDIR_CONSOLE_GETTY = \
	$(SYSTEMD_HACKS__SYSTEMD_CONFDIR)/system/console-getty.service.d
...
define SYSTEMD_HACKS_DO_INSTALL_MONGOOSE_CONFIG
	$(INSTALL) -D -m 0644 -- $(@D)/files/mongoose.conf \
		$(TARGET_DIR:/=)/etc/mongoose/default.conf
endef
SYSTEMD_HACKS_POST_INSTALL_TARGET_HOOKS += \
	SYSTEMD_HACKS_DO_INSTALL_MONGOOSE_CONFIG
endif
...
define SYSTEMD_HACKS_DO_INS_GETTY_AGETTY
	set -e; $(foreach rel_dest,\
		$(SYSTEMD_HACKS__SVCDIR_SERIAL_GETTY) \
		$(SYSTEMD_HACKS__SVCDIR_GETTY) \
		$(SYSTEMD_HACKS__SVCDIR_CONSOLE_GETTY),\
			$(INSTALL) -D -m 0644 -- '$(@D)/getty_agetty.conf' \
				'$(TARGET_DIR)$(rel_dest)/03-agetty.conf'; )
endef
...
ifeq ($(BR2_PACKAGE_SYSTEMD_HACKS_SVC_SETUP_AGETTY_AUTOLOGIN_TTY),y)
ifeq ($(call qstrip,$(BR2_PACKAGE_SYSTEMD_HACKS_SVC_SETUP_AGETTY_AUTOLOGIN_TTY_DEV)),)
define SYSTEMD_HACKS_DO_INSTALL_AUTOLOGIN_GETTY
	$(INSTALL) -D -m 0644 -- '$(@D)/getty_agetty_autologin.conf' \
		'$(TARGET_DIR)$(SYSTEMD_HACKS__SVCDIR_GETTY)/05-autologin.conf'
endef
else
define SYSTEMD_HACKS_DO_INSTALL_AUTOLOGIN_GETTY
	$(INSTALL) -D -m 0644 -- '$(@D)/getty_agetty_autologin.conf' \
		'$(TARGET_DIR)$(SYSTEMD_HACKS__SVCDIR_GETTY:.service.d=)$(call qstrip,$(BR2_PACKAGE_SYSTEMD_HACKS_SVC_SETUP_AGETTY_AUTOLOGIN_TTY_DEV)).service.d/05-autologin.conf'
endef
endif # TTY_DEV
SYSTEMD_HACKS_POST_INSTALL_TARGET_HOOKS += \
	SYSTEMD_HACKS_DO_INSTALL_AUTOLOGIN_GETTY
endif
# end BR2_PACKAGE_SYSTEMD_HACKS_SVC_SETUP_AGETTY_AUTOLOGIN_TTY

ifeq ($(BR2_PACKAGE_SYSTEMD_HACKS_SVC_SETUP_AGETTY_AUTOLOGIN_SERIAL_TTY),y)
ifeq ($(call qstrip,$(BR2_PACKAGE_SYSTEMD_HACKS_SVC_SETUP_AGETTY_AUTOLOGIN_SERIAL_TTY_DEV)),)
define SYSTEMD_HACKS_DO_INSTALL_AUTOLOGIN_SERIAL_GETTY
	$(INSTALL) -D -m 0644 -- '$(@D)/getty_agetty_autologin.conf' \
		'$(TARGET_DIR)$(SYSTEMD_HACKS__SVCDIR_SERIAL_GETTY)/05-autologin.conf'
endef
else
define SYSTEMD_HACKS_DO_INSTALL_AUTOLOGIN_SERIAL_GETTY
	$(INSTALL) -D -m 0644 -- '$(@D)/getty_agetty_autologin.conf' \
		'$(TARGET_DIR)$(SYSTEMD_HACKS__SVCDIR_SERIAL_GETTY:.service.d)$(call qstrip,$(BR2_PACKAGE_SYSTEMD_HACKS_SVC_SETUP_AGETTY_AUTOLOGIN_SERIAL_TTY_DEV)).service.d/05-autologin.conf'
endef
endif
SYSTEMD_HACKS_POST_INSTALL_TARGET_HOOKS += \
	SYSTEMD_HACKS_DO_INSTALL_AUTOLOGIN_SERIAL_GETTY
endif
# end BR2_PACKAGE_SYSTEMD_HACKS_SVC_SETUP_AGETTY_AUTOLOGIN_SERIAL_TTY

ifeq ($(BR2_PACKAGE_SYSTEMD_HACKS_SVC_SETUP_AGETTY_AUTOLOGIN_CONSOLE),y)
define SYSTEMD_HACKS_DO_INSTALL_AUTOLOGIN_CONSOLE
	$(INSTALL) -D -m 0644 -- '$(@D)/getty_agetty_autologin.conf' \
		'$(TARGET_DIR)$(SYSTEMD_HACKS__SVCDIR_CONSOLE_GETTY)/05-autologin.conf'
endef
SYSTEMD_HACKS_POST_INSTALL_TARGET_HOOKS += \
	SYSTEMD_HACKS_DO_INSTALL_AUTOLOGIN_CONSOLE
endif
# end SYSTEMD_HACKS_DO_INSTALL_AUTOLOGIN_CONSOLE


endif
# end BR2_PACKAGE_SYSTEMD_HACKS_SVC_SETUP_AGETTY_AUTOLOGIN
...
SYSTEMD_HACKS__UNITS_TO_ENABLE  += mongoose@default
else
